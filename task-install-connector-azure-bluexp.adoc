...
[role="lead"]
Puede crear un conector en Azure directamente desde BlueXP . Para crear un conector en Azure desde BlueXP , debe configurar la red, preparar un rol de Azure para usarlo para implementar el conector y, a continuación, implementar el conector.
