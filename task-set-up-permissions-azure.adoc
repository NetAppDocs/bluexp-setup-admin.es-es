...
[role="lead"]
Configure permisos de Azure para que pueda utilizar BlueXP para gestionar sus datos e infraestructura de almacenamiento en Azure. La forma de configurar los permisos depende de la opción de instalación que vaya a utilizar.
