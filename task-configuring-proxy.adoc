...
.. Especifique el servidor con la sintaxis http://[] o. https://[]
...
https://["Obtenga más información sobre el uso de un enlace privado de Azure o extremos de servicio con Cloud Volumes ONTAP"^]
