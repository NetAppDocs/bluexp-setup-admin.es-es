...
---
= Consulte los requisitos del host de Connector para las instalaciones de Azure
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Al poner en marcha el conector desde BlueXP o desde Azure Marketplace, la imagen incluye el sistema operativo y los componentes de software necesarios.
