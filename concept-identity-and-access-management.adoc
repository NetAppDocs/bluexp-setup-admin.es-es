...
Las carpetas pueden contener proyectos, otras carpetas o ambos.
...
Al asociar un recurso a una carpeta, este no se vuelve accesible automáticamente para todos los proyectos; solo el administrador de la carpeta o del proyecto puede verlo. El administrador de la carpeta o del proyecto decide qué proyectos pueden acceder a él y lo asocia con los proyectos correspondientes.
