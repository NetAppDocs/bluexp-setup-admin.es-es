...
[role="lead"]
La gestión de acceso e identidad de BlueXP  (IAM) es un mecanismo de control de acceso fundamental y escalable que administra el acceso de los usuarios a los recursos de BlueXP , otorgando niveles de permiso adecuados mediante roles de privilegios mínimos.

Con IAM, puede organizar y controlar el acceso a sus recursos de NetApp. Puede organizar sus recursos de acuerdo con la jerarquía de su organización. Por ejemplo, puede organizar recursos por ubicación geográfica, sitio o unidad de negocio. A continuación, puede asignar roles de IAM a miembros de partes específicas de la jerarquía, lo que impide el acceso a recursos en otras partes de la jerarquía.
...
Los usuarios deben tener el rol de administrador de organización o el rol de administrador de carpeta o proyecto para gestionar las carpetas. Los usuarios con la función Administrador de organización pueden crear y gestionar recursos en cualquier lugar de la organización de BlueXP . Los usuarios con rol de administrador de carpeta y proyecto sólo pueden hacerlo para las carpetas o proyectos a los que se han asignado.

Link::reference-iam-predefined-roles.html[Más información sobre los roles de BlueXP .]

Al utilizar BlueXP  IAM, los usuarios con estos roles gestionarán los siguientes componentes:
...
Una _ORGANIZATION_ es el nivel superior del sistema IAM de BlueXP  y, por lo general, representa a su empresa. Su organización consta de recursos como conectores, almacenamiento y suscripciones que puede organizar en carpetas y proyectos. A continuación, puede asignar a los miembros de la organización (usuario) acceso a carpetas o proyectos de acuerdo con sus responsabilidades en la gestión de sus entornos de almacenamiento.
...
Dependiendo del tamaño de la organización y del número de recursos de almacenamiento que tenga, las carpetas son una herramienta útil para mantener organizados los recursos de NetApp. También le permiten administrar mejor el acceso si desea compartir la administración de diferentes carpetas con diferentes usuarios. Puede asignar a un usuario la función de administrador de carpeta o proyecto para una carpeta concreta y, a continuación, podrá gestionar el acceso a la carpeta y sus proyectos, así como crear nuevos proyectos en la carpeta.

Al crear una carpeta, puede asignar a los usuarios acceso a ella. Al asignar un rol de acceso a una carpeta a un usuario, dicho usuario puede realizar las tareas asociadas a ese rol para todos los proyectos dentro de la carpeta respectiva. Por el contrario, puede optar por otorgar acceso de usuario en un proyecto por proyecto en su lugar.
...
Usted crea múltiples proyectos para proporcionar un acceso más granular a sus recursos de NetApp. Por ejemplo, las organizaciones más pequeñas pueden tener un proyecto para cada unidad de negocio o ubicación geográfica. Puede que organizaciones de mayor tamaño deseen organizar sus recursos de almacenamiento en varios proyectos por unidad de negocio para seguir controlando el acceso. Puede asignar a los usuarios acceso a los recursos por proyecto o carpeta.
...
Cuando sus proyectos residen en una carpeta, puede hacerlo
