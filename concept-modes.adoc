...
| Backup y recuperación | Solo se admiten los backups y restauraciones de volúmenes ONTAP en las instalaciones en sistemas StorageGRID.
...
.17+| *Servicios* | Backup y recuperación | Sí | Sí 
