...
.16+| *Servicios* | Alertas | No | No 


| Backup y recuperación | Síhttps://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-limited-internet-connectivityView[] la lista de destinos de respaldo admitidos para datos de volumen ONTAP ^] | Síhttps://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-no-internet-connectivity["Consulte la lista de destinos de backup admitidos para los datos de volúmenes ONTAP"^] 
