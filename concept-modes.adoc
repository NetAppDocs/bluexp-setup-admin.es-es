...
Cada modo de implementación difiere en términos de requisitos de conectividad saliente, ubicación de implementación, proceso de instalación, método de autenticación, servicios de datos y almacenamiento disponibles y métodos de cobro.

Modo estándar:: Utiliza un servicio SaaS desde la consola web. Según los servicios de datos y las funciones que planee usar, un administrador de BlueXP crea uno o más conectores para administrar los datos en su entorno de nube híbrida.
+
--
Este modo utiliza la transmisión de datos cifrados a través de Internet pública.

--
Modo restringido:: Instala un conector BlueXP en la nube (en una región gubernamental, una región de nube soberana o una región comercial) y tiene conectividad saliente limitada a la capa SaaS de BlueXP. Los usuarios acceden a BlueXP localmente desde la consola basada en Web que está disponible desde el conector, no desde la capa SaaS.
+
--
...
--
Modo privado:: Instala un conector BlueXP en sus instalaciones o en la nube (en una región segura, una región de nube soberana o una región comercial) y _no_ tiene conectividad con la capa SaaS de BlueXP. Los usuarios acceden a BlueXP localmente desde la consola basada en Web que está disponible desde el conector, no desde la capa SaaS.
+
--
