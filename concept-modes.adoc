...
+
--
Una región segura incluye https://["AWS C2S Y SC2S"^] y.. https://["Azure IL6"^]
...
Cómo comenzar con el modo estándar:: Vaya a la https://["Consola BlueXP basada en Web"^] y regístrese.
+
--
...
| Backup y recuperación | Compatible con regiones comerciales de AWS y Azure. No es compatible con Google Cloud ni en https://["AWS C2S/SC2S"^] o. https://["Azure IL6"^] 
...
| Backup y recuperación | Solo se admiten los backups y restauraciones de volúmenes ONTAP en las instalaciones en sistemas StorageGRID.https://["Descubra cómo realizar backups de datos de ONTAP en las instalaciones en StorageGRID"^] 


| Clasificación  a| 
* Las únicas fuentes de datos admitidas son las que se pueden detectar localmente.
+
https://["Ver las fuentes que puede descubrir localmente"^]

* Las funciones que requieren acceso saliente a Internet no son compatibles.
+
https://["Vea las limitaciones de la función"^]
...
https://["Descubre cómo añadir licencias a la cartera digital de BlueXP"^]
