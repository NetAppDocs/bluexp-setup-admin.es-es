...
| Backup y recuperación | Se admite en regiones gubernamentales y regiones comerciales con modo restringido. No se admite en regiones soberanas con modo restringido.

Las siguientes funciones no son compatibles: Aplicaciones, máquinas virtuales y Kubernetes. 
...
| Backup y recuperación | Compatible con regiones comerciales de AWS y Azure.

No es compatible con Google Cloud ni en https://aws.amazon.com/federal/secret-cloud/["Cloud secreto de AWS"^], https://aws.amazon.com/federal/top-secret-cloud/["Cloud secreto principal de AWS"^], o. https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-dod-il6["Azure IL6"^] 
...
* Se admiten los backups y la restauración de volúmenes de ONTAP en las instalaciones en sistemas StorageGRID.
+
https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-onprem-private-cloud.html["Descubra cómo realizar backups de datos de ONTAP en las instalaciones en StorageGRID"^]

* También se admiten los procesos de backup y restauración de volúmenes de ONTAP en las instalaciones en ONTAP S3.
+
https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-onprem-to-ontap-s3.html["Descubra cómo realizar backups de los datos de ONTAP en las instalaciones en ONTAP S3"^]
...
.16+| *Servicios* | Backup y recuperación | Sí | Sí 
...
.5+| * Características* | Credenciales | Sí | Sí 
