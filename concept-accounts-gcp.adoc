...
summary: Descubre cómo BlueXP utiliza las credenciales y los permisos de Google Cloud para poder gestionar las credenciales de uno o más proyectos de Google Cloud. Por ejemplo, es posible que desee obtener información sobre la cuenta de servicio asociada a la VM de Connector. 
---
...
[role="lead"]
Descubre cómo BlueXP utiliza las credenciales y los permisos de Google Cloud para poder gestionar las credenciales de uno o más proyectos de Google Cloud. Por ejemplo, es posible que desee obtener información sobre la cuenta de servicio asociada a la VM de Connector.
