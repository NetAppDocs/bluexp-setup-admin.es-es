...
Al crear el conector desde BlueXP se implementa una instancia de EC2 en AWS con una configuración predeterminada. link:reference-connector-default-config.html["Obtenga información sobre la configuración predeterminada para el conector"].
