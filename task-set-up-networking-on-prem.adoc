...
\https://login.microsoftonline.com | Para gestionar recursos en regiones públicas de Azure. 


| \https://management.chinacloudapi.cn
\https://login.chinacloudapi.cn | Para gestionar recursos en regiones de Azure China. 
