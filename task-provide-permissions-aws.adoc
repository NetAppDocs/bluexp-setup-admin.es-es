...
.Resultado
BlueXP dispone ahora de los permisos que necesita para realizar acciones en AWS en su nombre. Vaya a la https://["Consola BlueXP"^] Para empezar a utilizar el conector con BlueXP.
