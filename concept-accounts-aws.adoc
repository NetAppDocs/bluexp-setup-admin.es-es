...
summary: Descubre cómo BlueXP utiliza las credenciales y los permisos de AWS para poder gestionar las credenciales de una o más cuentas de AWS. Por ejemplo, quizás quieras más información sobre cómo añadir credenciales de AWS adicionales a BlueXP. 
---
...
[role="lead"]
Descubre cómo BlueXP utiliza las credenciales y los permisos de AWS para poder gestionar las credenciales de una o más cuentas de AWS. Por ejemplo, quizás quieras más información sobre cómo añadir credenciales de AWS adicionales a BlueXP.
