...
Para obtener más información, consulte https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/requirements/task-setting-up-permissions-fsx.html["Documentación de BlueXP para Amazon FSX para ONTAP"^]
