...
Cuando te suscribes a BlueXP desde AWS Marketplace, el último paso del proceso es asociar la suscripción a tus cuentas de BlueXP desde el sitio web de BlueXP. Si no has completado este paso, no podrás usar la suscripción con tu cuenta de BlueXP.
...
.Pasos
. Ve a la cartera digital de BlueXP para confirmar que no has asociado tu suscripción a tu cuenta de BlueXP.
+
...
. Ve a la cartera digital de BlueXP para confirmar que la suscripción está asociada a tu cuenta de BlueXP.
+
.. En el menú de navegación de BlueXP, seleccione *Gobierno > cartera digital*.
.. Seleccione *Suscripciones*.
...
+
.. En la parte superior derecha de la consola de BlueXP, seleccione el icono Configuración y seleccione *credenciales*.
.. En la página *Account credentials*, verifique que la suscripción esté asociada con sus credenciales de AWS.
+
Veamos un ejemplo.
