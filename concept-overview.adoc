...
+
--
* Configuración y uso https://["Cloud Volumes ONTAP"^] para lograr una gestión de datos eficiente con varios protocolos en todos los clouds.
* Configure y utilice los servicios cloud de almacenamiento de archivos:
+
** https://["Azure NetApp Files"^]
** https://["Amazon FSX para ONTAP"^]
** https://["Cloud Volumes Service para Google Cloud"^]


* Detectar y gestionar https://["almacenamiento en las instalaciones"^]:
+
** Sistemas E-Series
** Clústeres ONTAP
...
* Orquestar y proteger https://["Datos persistentes de Kubernetes"^]
...
+
--
* https://["Copiar y sincronizar"^]
* https://["Almacenamiento en caché en el edge"^]
* https://["Organización en niveles"^]
...
--
* https://["Clasificación"^]
* https://["Asesor digital"^]
* https://["Protección contra ransomware"^]


--


https://["Obtenga más información sobre cómo puede utilizar BlueXP para ayudar a su organización"^]
...
El precio de BlueXP depende de los servicios que usted planea utilizar. https://["Más información sobre los precios de BlueXP"^]
...
BlueXP es accesible a través de un https://["consola basada en web"^] Y API. Esta experiencia SaaS le permite acceder automáticamente a las últimas funciones a medida que se publican y cambiar fácilmente entre sus cuentas y conectores de BlueXP.
