...
==== Actualización de permisos de Azure

Hemos actualizado la política Connector para Azure para incluir los siguientes permisos:
...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html["Obtenga más información sobre la compatibilidad de Cloud Volumes ONTAP con conjuntos de escala de máquinas virtuales"^]
...
=== Se han actualizado los requisitos del motor Docker
...
=== Verificación de correo electrónico ahora necesaria
...
==== Fin de soporte para RHEL 7 y CentOS 7
...
=== Petición de datos para actualizar las credenciales de NSS
...
=== Dirección de correo electrónico para cuentas NSS
...
=== Se requiere una actualización para las cuentas del sitio de soporte de NetApp
...
=== Cambie las cuentas NSS para Cloud Volumes ONTAP
...
=== El conector ya no se admite como proxy
...
=== Mejoras para agregar el asistente de conector
...
=== Gestión de cuentas NSS desde la consola de soporte
...
=== Llamadas API directamente a Cloud Manager
...
=== Usuarios de la cuenta de servicio
...
=== Mejoras de la organización en niveles del cloud
