...
+
https://["Consulte la lista completa de las regiones admitidas"^]

* Esta versión del conector incluye mejoras de Cloud Volumes ONTAP.
+
https://["Obtenga información acerca de las mejoras de Cloud Volumes ONTAP"^]
...
https://["Obtenga más información sobre estos modos de implementación"].
...
+
https://["Aprenda a configurar notificaciones por correo electrónico"].
...
+
https://["Aprenda a gestionar las credenciales de usuario"].
...
+
https://["Descubra cómo crear y gestionar casos de soporte"].
...
+
** https://["Obtenga información acerca de las mejoras de Cloud Volumes ONTAP"^]
** https://["Obtenga información acerca de las mejoras del clúster en las instalaciones de ONTAP"^]
...
+
https://["Aprenda a gestionar sus casos de soporte"].
...
+
** https://["Instale el conector en una ubicación sin acceso a Internet"^]
** https://["Acceda a la consola BlueXP del conector"^]
** https://["Añada una licencia sin asignar"^]
** https://["Empiece a usar Cloud Volumes ONTAP"^]


* El conector ahora le permite agregar y gestionar cubos de Amazon S3 desde BlueXP.
+
https://["Vea cómo añadir nuevos bloques de Amazon S3 en su cuenta de AWS desde BlueXP"^].
...
+
** https://["Aprenda a asociar una suscripción a AWS"]
** https://["Aprenda a asociar una suscripción a Azure"]
** https://["Descubra cómo asociar una suscripción a Google Cloud"]


* BlueXP le notificará ahora si su conector ha sido apagado durante 14 días o más.
+
** https://["Más información sobre las notificaciones de BlueXP"]
** https://["Descubra por qué los conectores deben seguir funcionando"]
...
+
https://["Vea los permisos de Google Cloud para Connector"].
...
* Hemos actualizado la URL de la consola BlueXP a. https://[]
...
+
https://["Obtenga información sobre cómo administrar sus suscripciones"^]
...
Cloud Manager ahora le solicita que actualice las credenciales asociadas con sus cuentas del sitio de soporte de NetApp cuando el token de actualización asociado con su cuenta caduque después de 3 meses. https://["Aprenda a gestionar cuentas de NSS"^]
...
+
https://["Aprenda a descubrir FSX para ONTAP con mis oportunidades"^]
...
https://["A continuación se muestra un ejemplo en el que se muestran los permisos de la función IAM de AWS que se utilizan para crear un conector"].

También hemos creado una página que proporciona enlaces a cada una de las políticas. https://["Consulte el resumen de permisos de Cloud Manager"].
...
+
https://["Obtenga más información sobre cómo supervisar operaciones en su cuenta"].
...
* Hemos certificado Connector en Google Cloud en una instancia de máquina virtual con un sistema operativo compatible https://["Características de VM blindadas"^]
* Esta versión del conector también incluye mejoras de Cloud Volumes ONTAP. https://["Obtenga información sobre estas mejoras"^]
...
+
https://["Aprenda a crear un conector con el rol IAM"].
...
Esta versión del conector incluye mejoras de Cloud Volumes ONTAP. https://["Obtenga información sobre estas mejoras"^]
...
https://["Consulte la lista de los extremos necesarios"]
...
* https://["Obtenga más información sobre el uso de Microsoft Azure AD por parte de NetApp para la gestión de identidades"^]
...
https://["Consulte los informes de SOC 2 de NetApp"^].
...
https://["Obtenga más información sobre la verificación de AutoSupport con Cloud Volumes ONTAP"^]
