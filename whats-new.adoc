...
==== Compatibilidad con Docker Engine 26

Docker Engine es la herramienta de orquestación de contenedores necesaria al instalar el conector en Ubuntu 22,04 LTS.

A partir de la versión 3.9.44 del conector, Docker Engine 26 ahora es compatible con instalaciones _new_ Connector.

La lista actualizada de versiones de Docker Engine compatibles es la siguiente:
