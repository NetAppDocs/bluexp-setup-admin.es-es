...
summary: la federación de identidades habilita el inicio de sesión único con BlueXP para que los usuarios puedan iniciar sesión utilizando credenciales de su identidad corporativa. Debe comprender cómo BlueXP admite la federación de identidades antes de configurar una conexión con su proveedor de identidades. 
---
...
[role="lead"]
la federación de identidades habilita el inicio de sesión único con BlueXP para que los usuarios puedan iniciar sesión utilizando credenciales de su identidad corporativa. Debe comprender cómo BlueXP admite la federación de identidades antes de configurar una conexión con su proveedor de identidades.
...
== Actualizar una conexión federada
