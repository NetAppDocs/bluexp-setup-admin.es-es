...
summary: Cree el conector directamente desde la consola basada en web de BlueXP, desde Azure Marketplace o instalando el software en su propio host Linux. 
---
= Cree el conector en Azure
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cree el conector directamente desde la consola basada en web de BlueXP, desde Azure Marketplace o instalando el software en su propio host Linux.
