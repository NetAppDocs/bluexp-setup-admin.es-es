...
summary: Una cuenta de BlueXP proporciona multi-tenancy a tu organización, lo que te permite organizar usuarios y recursos en espacios de trabajo aislados. Por ejemplo, un grupo de usuarios puede desplegar y gestionar sistemas Cloud Volumes ONTAP en un espacio de trabajo que no es visible para otros usuarios que gestionan diferentes tipos de entornos de trabajo en un espacio de trabajo diferente. 
---
