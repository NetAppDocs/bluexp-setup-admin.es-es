...
.Resultado
BlueXP dispone ahora de los permisos que necesita para realizar acciones en AWS en su nombre. Ahora puede ir al https://["Consola BlueXP"^] Para empezar a utilizar el conector con BlueXP.
...
.Resultado
BlueXP ahora tiene los permisos que necesita para realizar acciones en Azure en su nombre. Ahora puede ir al https://["Consola BlueXP"^] Para empezar a utilizar el conector con BlueXP.
