...
.Antes de empezar
La suscripción a BlueXP implica asociar una suscripción al mercado con las credenciales de la nube asociadas con un conector. Si ha seguido el flujo de trabajo para empezar con el modo estándar, ya debe tener un conector. Para obtener más información, consulte la link:task-quick-start-standard-mode.html["Inicio rápido para BlueXP en modo estándar"].
...
+
.. Cuando se le haya redirigido a. https://["Página de BlueXP de NetApp en Google Cloud Marketplace"^], asegúrese de seleccionar el proyecto correcto en el menú de navegación superior.
+
...
NOTE: Si alguien de su organización ya se ha suscrito a la suscripción de NetApp BlueXP desde su cuenta de facturación, se le redirigirá a https://["La página Cloud Volumes ONTAP en el sitio Web de BlueXP"^] en su lugar. Si esto no se realiza de forma inesperada, póngase en contacto con el equipo de ventas de NetApp. Google sólo activa una suscripción por cuenta de facturación de Google.
...
* https://["Gestione las licencias basadas en la capacidad de su propia licencia para Cloud Volumes ONTAP"^]
* https://["Gestiona las licencias BYOL para los servicios de datos de BlueXP"^]
* https://["Gestione las credenciales y suscripciones de AWS para BlueXP"]
* https://["Gestione credenciales y suscripciones de Azure para BlueXP"]
* https://["Administrar las credenciales y suscripciones de Google Cloud para BlueXP"]
