...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-aws-accounts.html["Gestione las credenciales y suscripciones de AWS para BlueXP"]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-azure-accounts.html["Gestione credenciales y suscripciones de Azure para BlueXP"]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-gcp-accounts.html["Administrar las credenciales y suscripciones de Google Cloud para BlueXP"]
