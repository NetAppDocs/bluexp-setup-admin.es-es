...
[NOTE]
====
* Las notificaciones se envían por correo electrónico de las siguientes características y servicios de BlueXP : Conector, cartera digital de BlueXP , copia y sincronización de BlueXP  y copia de seguridad y recuperación de BlueXP .
