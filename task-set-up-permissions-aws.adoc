...
Si es necesario, puede restringir la política de IAM mediante el IAM `Condition` elemento. https://["Documentación de AWS: Elemento de condición"^]
...
+
A modo de recordatorio, esta política solo contiene los permisos necesarios para iniciar la instancia de Connector en AWS desde BlueXP. link:reference-permissions-aws.html["Permite ver los permisos necesarios para la instancia de conector"].
