...
| Llamadas API y AutoSupport | HTTPS | 443 | LIF de gestión de clústeres de ONTAP y Internet saliente | Llamadas API a Azure, a ONTAP, a la clasificación de BlueXP, a la protección contra ransomware de BlueXP y al enviar mensajes de AutoSupport a NetApp 
