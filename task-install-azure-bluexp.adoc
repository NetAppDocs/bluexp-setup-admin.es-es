...
[role="lead"]
Configura la red, prepara permisos de Azure y, a continuación, crea un conector en Azure desde BlueXP.



== Información general sobre la implementación

Los siguientes pasos proporcionan un resumen de alto nivel de las tareas que completará en esta página. En las siguientes secciones encontrará más información sobre cada uno de estos pasos.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["Uno"] Configure las redes
[role="quick-margin-para"]
Configure su red para que Connector pueda gestionar recursos y procesos en su entorno de cloud híbrido. Por ejemplo, necesita una red virtual que tenga acceso a Internet saliente y conexiones de red a las redes de destino.

[role="quick-margin-para"]
<<Configure las redes,Ver los requisitos de red>>.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["Dos"] Configure los permisos de Azure
[role="quick-margin-para"]
Cree un rol personalizado y luego aplíquelo a su cuenta de Azure o a un director de servicio de Azure AD. BlueXP autentica con Azure y utiliza estos permisos para crear la instancia de Connector en su nombre.

[role="quick-margin-para"]
<<Configure los permisos de Azure,Siga las instrucciones paso a paso>>.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["Tres"] Cree el conector
[role="quick-margin-para"]
En BlueXP, haz clic en el menú desplegable Conector, selecciona *Añadir conector* y sigue las indicaciones.

[role="quick-margin-para"]
<<Cree el conector,Siga las instrucciones paso a paso>>.



== Configure las redes

Asegúrese de que la ubicación de red en la que planea instalar el conector admite los siguientes requisitos.
...
Conexiones a redes de destino:: Un conector requiere una conexión de red a la ubicación en la que tiene previsto crear y administrar entornos de trabajo. Por ejemplo, la vnet donde planea crear sistemas Cloud Volumes ONTAP o el almacenamiento en su entorno local.
Acceso a Internet de salida:: La ubicación de red en la que se despliega el conector debe tener una conexión a Internet saliente para contactar puntos finales específicos, como se describe en las siguientes secciones.
...
--
Limitación de dirección IP:: Puede haber un conflicto con las direcciones IP en el rango 172. https://docs.netapp.com/us-en/bluexp-setup-admin/reference-limitations.html["Obtenga más información sobre esta limitación"].
...
Para implementar Connector, BlueXP debe autenticarse con Azure. Es posible elegir entre dos métodos de autenticación de Azure.
...
+
<<Configure un método de autenticación,Aprenda cómo obtener estos valores para un director de servicio>>.
