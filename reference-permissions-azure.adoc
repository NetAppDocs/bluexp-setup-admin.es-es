...
* link:task-set-up-permissions-azure.html["Configurar permisos para la instalación de Connector en Azure (modo estándar)"]
...
El conector realiza las siguientes solicitudes de la API para gestionar etiquetas de recursos de Azure cuando utiliza la corrección de BlueXP:
...
* Microsoft.Storage/storageAccounts/blobServices/contenedores/escritura
+
Se necesita este permiso para backup y recuperación y para la organización en niveles de BlueXP.

* Microsoft.Network/publicIPAddresses/delete
+
Se requiere este permiso para realizar backup y recuperación de BlueXP.
