...
summary: Debe comprender cómo utiliza BlueXP las credenciales y los permisos de Azure para poder gestionar las credenciales de una o más suscripciones de Azure. 
---
...
[role="lead"]
Debe comprender cómo utiliza BlueXP las credenciales y los permisos de Azure para poder gestionar las credenciales de una o más suscripciones de Azure.
