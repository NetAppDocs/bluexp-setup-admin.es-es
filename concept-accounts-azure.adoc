...
summary: Debe comprender cómo utiliza BlueXP las credenciales y los permisos de Azure para poder gestionar las credenciales de una o más suscripciones de Azure. Por ejemplo, quizás quieras más información sobre cómo añadir credenciales de Azure adicionales a BlueXP. 
---
...
[role="lead"]
Debe comprender cómo utiliza BlueXP las credenciales y los permisos de Azure para poder gestionar las credenciales de una o más suscripciones de Azure. Por ejemplo, quizás quieras más información sobre cómo añadir credenciales de Azure adicionales a BlueXP.
