...
summary: Cree el conector directamente desde la consola basada en Web BlueXP, mediante gcloud o instalando el software en su propio host Linux. 
---
= Cree el conector en Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cree el conector directamente desde la consola basada en Web BlueXP, mediante gcloud o instalando el software en su propio host Linux.
