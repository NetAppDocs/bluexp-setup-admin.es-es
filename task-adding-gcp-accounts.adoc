...
.Pasos
. Desplácese hasta la https://["Página de BlueXP de NetApp en Google Cloud Marketplace"^] para comprobar el estado del pedido. Si la página indica *Administrar en Proveedor*, desplácese hacia abajo y seleccione *gestionar pedidos*.
+
