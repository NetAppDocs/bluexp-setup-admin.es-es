...
summary: Puede gestionar las credenciales de Google Cloud asociadas con la instancia de Connector VM. 
---
...
[role="lead"]
Puede gestionar las credenciales de Google Cloud asociadas con la instancia de Connector VM.
