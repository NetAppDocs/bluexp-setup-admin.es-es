...
| link:reference-iam-gncv-roles.html["Administrador de Google Cloud NetApp Volumes"] | Los usuarios con la función Google Cloud NetApp Volumes pueden descubrir y administrar Google Cloud NetApp Volumes. 
