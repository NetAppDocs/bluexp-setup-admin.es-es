...
summary: Instale el conector en AWS directamente desde la consola basada en web de BlueXP, desde AWS Marketplace o mediante la instalación del software en su propio host Linux. 
---
= Cree el conector en AWS
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cree el conector directamente desde la consola basada en web de BlueXP, desde AWS Marketplace o instalando el software en su propio host Linux.
