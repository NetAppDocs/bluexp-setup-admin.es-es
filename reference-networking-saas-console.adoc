...
| Necesario para implementar un conector desde BlueXP en AWS. El extremo exacto depende de la región en la que se despliega el conector. https://["Consulte la documentación de AWS para obtener más detalles."^] 
